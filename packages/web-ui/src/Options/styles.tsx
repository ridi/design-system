  ...
  (() => {
    switch (separator) {
      case 'dot':
        return {
          backgroundSize: '3px',
          backgroundImage: `url(${Svg.renderToDataUri(<Svg render={dot_1} fill={colors.slateGray20} />)})`,
        };
      case 'pipe':
      default:
        return {
          backgroundSize: '1px 100%',
          backgroundImage: `url(${Svg.renderToDataUri(<Svg render={dot_2} fill={colors.slateGray10} preserveAspectRatio="none" />)})`,
        };
    }
  })(),
);
